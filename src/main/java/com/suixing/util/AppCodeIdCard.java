...
//            throw new BizException("图片格式仅支持JPG、PNG！");
    ...
    public static ServerResponse personCard(MultipartFile multipartFile) throws Exception {
        ...
        configObj.put("side", new String("face"));
